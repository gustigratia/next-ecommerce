          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
            <main className="lg:col-span-2">
              <article className="border border-gray-200 bg-white shadow-sm rounded p-5 lg:p-6 mb-5">
                ...
                <div className="space-y-4">
                  {order.orderItems.map((item) => (
                    <div key={item.product} className="flex gap-4 border-b border-gray-200 pb-4">
              ...
              <article className="border border-gray-200 bg-white shadow-sm rounded p-5 lg:p-6">
                ...
                <p className="mb-1">
                  <span className="font-medium">Name:</span> {order.shippingInfo.fullName}
                </p>
                ...
                <p className="mb-1">
                  <span className="font-medium">Address:</span> {order.shippingInfo.address}
                </p>

                <p className="mb-1">
                  <span className="font-medium">City:</span> {order.shippingInfo.city}
                </p>

                <p className="mb-1">
                  <span className="font-medium">Postal Code:</span> {order.shippingInfo.postalCode}
                </p>

                <p>
                  <span className="font-medium">Country:</span> {order.shippingInfo.country}
                </p>
              </article>
            </main>
              ...
              <article className="border border-gray-200 bg-white shadow-sm rounded p-5 lg:p-6">
                ...
                <ul className="mb-5">
                  <li className="flex justify-between text-gray-600 mb-1 gap-4">
                    <span>Order ID:</span>
                    <span className="text-right text-sm break-all">{order._id}</span>
                  </li>
